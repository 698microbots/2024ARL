...
public class LimeLightHelpersSubsystem {
    ...
    public static LimelightResults getLatestResults(String limelightName) {
        ...
        LimeLightHelpersSubsystem.LimelightResults results = new LimeLightHelpersSubsystem.LimelightResults();
        if (mapper == null) {
    ...
    public static double getDistToSpeaker(double vertAngle) {
