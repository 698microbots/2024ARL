 ...
 */
public interface SwerveRequestMODIFIED {
     ...
     * oppose any motion.
     */
    public class SwerveDriveBrake implements SwerveRequestMODIFIED {
        ...
        public StatusCode apply(SwerveControlRequestParameters parameters, SwerveModule... modulesToApply) {
            ...
            SwerveDriveKinematics.desaturateWheelSpeeds(states, 3.5); //MAX SPEED AT THE END HERE COULDNT ADD IT BECAUSE OF INTERFACE
            for (int i = 0; i < modulesToApply.length; ++i) {
     ...
     */
    public class FieldCentric implements SwerveRequestMODIFIED {
        /**
     ...
     */
    public class FieldCentricFacingAngle implements SwerveRequestMODIFIED {
        /**
         * The velocity in the X direction, in m/s.
         * X is defined as forward according to WPILib convention,
         * so this determines how fast to travel forward.
     ...
     */
    public class Idle implements SwerveRequestMODIFIED {
        public StatusCode apply(SwerveControlRequestParameters parameters, SwerveModule... modulesToApply) {
            return StatusCode.OK;
        }
    }
     ...
     */
    public class PointWheelsAt implements SwerveRequestMODIFIED {
     ...
     * turn counterclockwise at 0.5 rad/s.
     */
    public class RobotCentric implements SwerveRequestMODIFIED {
        /**
         * The velocity in the X direction, in m/s.
         * X is defined as forward according to WPILib convention,
         * so this determines how fast to travel forward.
     ...
     */
    public class ApplyChassisSpeeds implements SwerveRequestMODIFIED {
